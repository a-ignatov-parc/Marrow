...
// __История версий:__  
// 
// * `1.0.3` - Теперь в транзиты обязательно нужно передавать объект опций.
// 
// * `1.0.2` - Добавлен транзит селекторов из песочницы на главный объект `window`.
// 
// * `1.0.1` - Добавлен вызов метода `afterInit`.
// 
