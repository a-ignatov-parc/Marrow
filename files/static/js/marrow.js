...
// __История версий:__  
// 
// * `1.3.6` - Все транзиты вынесены в отдельные модули и создана система подключения и запуска 
// любого кол-ва подключаемых транзитов. Сделан багофикс класса `core.Perf`.
// 
// * `1.3.5` - Исправлена работа транзита селекторов в последних версиях jquery.
// 
// * `1.3.4` - В дефолтные параметры объекта `hosts` добавлена ссылка на папку `html`.
// 
// * `1.3.3` - Добавлена возможность отключать использование транзита через опции приложения.
// 
// * `1.3.2` - Исправлена ошибка когда при инициализации не синхронизировались роуты.
// 
// * `1.3.1` - Добавлен метод для трансляции урлов с песочницы на главную страницу и обратно.
// 
// * `1.3.0` - Из `core.js` вынесены все методы связанные с `backbone.js` в `core.sugar.js`, а так 
// же сделан рефакторин остальных методов.
// 
// * `1.2.5` - Расширен функционал форматирования даты в методе `dateUTC`.
// 
// * `1.2.4` - Реализован метод создающий транзит селекторов из песочницы на главный объект 
// `window`.
// 
// * `1.2.3` - Добавлены дефолтные переменные для приложения + максимально вынесены методы 
// завязанные на рецепт.
// 
// * `1.2.2` - Исправлена ошибка в методе `dateUTC` если в него не передана дата.
// 
// * `1.2.1` - Удален метод компиляции шаблонов так как они теперь будут заранее скомпилированы.
// 
// * `1.2.0` - Класс ядра переделан для правильной работы в полноценной песочнице.
// 
...
// __История версий:__  
// 
// * `1.0.2` - Добавлен хак для получения ссылки на `jQuery` объект объекта `window` песочницы.
// 
// * `1.0.1` - Небольшой рефакторинг и проверка существование `jQuery`, как зависимость для 
// работы + рефакторинг кода.
// 
// * `1.0.0` - Транзит для селекторов `jQuery` вынесен в отдельный файл.
// 
